...
public final class KafkaEventProducer {
	...
	public KafkaEventProducer(String bootstrapServer,  Map<String, Object> optionalProperties) {
	...
	public void publishEvent(String eventAsString, String topic) throws InterruptedException, ExecutionException, TimeoutException {
		LOG.info("Produce to topic: " + topic + " message: \n"+eventAsString);
